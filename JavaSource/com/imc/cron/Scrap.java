...
public class Scrap {
	...
	public void scrapHtmlPage(String url) throws Exception{
	 ...
	 public void getBrandTitle() throws Exception{
		 try{
	...
	public void saveBrands() throws Exception{
	 ...
	 public void persistMobilePhoneData() throws Exception{
		 try{
		 Set<MobileNetworks> setMobileToNetwork = new HashSet<>();
		 Set<MobileAlertTypes> setMobileToAlertTypes = new HashSet<>();
		 Set<MobileDisplayTypes> setMobileToDisplay = new HashSet<>();
		 Set<MobileDisplayProtection> setMobileToProtection = new HashSet<>();
		 Set<MobileMemoryCardslots> setMobileToMemoryCardSlots = new HashSet<>();
		 Set<MobileMemory> setMobileToMemory = new HashSet<>();
		 Set<MobileDataSpeeds> setMobileToDataSpeed = new HashSet<>();
		 Set<MobileNfc> setMobileToNfc = new HashSet<>();
		 Set<MobileCameraPrimary> setMobileToCameraPrimaries = new HashSet<>();
		 Set<MobileCameraFeatures> setMobilePhoneToCameraFeatures = new HashSet<>();
		 Set<MobileCameraVideo> setMobileToCameraVideos = new HashSet<>();
		 Set<MobileCameraSecondary> setMobileToCameraSecondaries = new HashSet<>();
		 Set<MobileSensors> setMobileToSensors = new HashSet<>();
		 Set<MobileMessaging> setMobileToMessagings = new HashSet<>();
		 Set<MobileBrowsers> setMobilePhoneToBrowsers = new HashSet<>();
		 Set<MobileRadio> setMobilePhoneToRadios = new HashSet<>();
		 Set<MobileGames> setMobilePhoneToGames = new HashSet<>();
		 
		 
		 Set<MobileFeatures> setMobileToFeatures = new HashSet<>();
		 Set<MobileJava> setMobilePhoneToJavas = new HashSet<>();
		 Set<MobileColors> setMobilePhoneToColors = new HashSet<>();
		 ...
		 Elements elements = pageSoup.getElementById("specs-list").children();//tables
												...
												if(((ttl.equalsIgnoreCase("2G Network")) || (ttl.equalsIgnoreCase("3G Network")
													...
													try{
														if(nfo != null){
															...
															setMobileToNetwork.add(mobileNetworks);
														}
													}catch(Exception e){
													...
													try{
														if(nfo != null){
															...
															for(String alert : alerts){
																...
																setMobileToAlertTypes.add(alertTypes);
															}
														}
													}catch(Exception e){
													...
													try{
														if(nfo != null){
															...
															for(String type : types){
																...
																setMobileToDisplay.add(displayType);
															}
													...
													try{
														if(nfo != null){
															...
															for(String protection : protections){
																...
																setMobileToProtection.add(displayProtection);
															}
														}
													}catch(Exception e){
													...
													try{
														if(nfo != null){
															...
															for(String cardslot : cardslots){
																...
																setMobileToMemoryCardSlots.add(cardSlots);
															}
													...
													try{
														if(nfo != null){
															...
															for(String iMemory : internalMemory){
																...
																setMobileToMemory.add(mobileMemory);
															}
													...
													try{
														if(nfo != null){
															...
															for(String speed : speeds){
																...
																setMobileToDataSpeed.add(mobileDataSpeeds);
															}
													...
													try{
														if(nfo != null){
															...
															for(String primary : primaries){
																...
																setMobileToCameraPrimaries.add(mobileCameraPrimary);
															}
													...
													try{
														if(nfo != null){
															...
															for(String feature : features){
																...
																setMobilePhoneToCameraFeatures.add(mobileCameraFeatures);
															}
													...
													try{
														if(nfo != null){
															...
															for(String video : videos){
																...
																setMobileToCameraVideos.add(mobileCameraVideo);
															}
													...
													try{
														if(nfo != null){
															...
															for(String secondory : secondories){
																...
																setMobileToCameraSecondaries.add(mobileCameraSecondary);
															}
													...
													try{
														if(nfo != null){
															...
															for(String sensor : sensors){
																...
																setMobileToSensors.add(mobileSensors);
															}
													...
													try{
														if(nfo != null){
															...
															for(String message :messages ){
																...
																setMobileToMessagings.add(mobileMessaging);
															}
														}
													}catch(Exception e){
													...
													try{
														if(nfo != null){
															...
															for(String browser :browsers ){
																...
																setMobilePhoneToBrowsers.add(mobileBrowsers);	
															}
													...
													try{
														if(nfo != null){
															...
															for(String radio :radios ){
																...
																setMobilePhoneToRadios.add(mobileRadio);	
															}
													...
													try{
														if(nfo != null){
															...
															for(String game :games ){
																...
																setMobilePhoneToGames.add(mobileGames);	
															}
													...
													try{
														if(nfo != null){
															...
															for(String java : javas){
																...
																setMobilePhoneToJavas.add(mobileJava);
															}
														}
													}catch(Exception e){
												...
												if(ttl.equalsIgnoreCase("Colors") && ttl != null){
													...
													if(nfo != null){
														...
														for(String color : colors){
															...
															setMobilePhoneToColors.add(mobileColors);
														}
													}
													}catch(Exception e){
													...
													try{
														if(nfo != null){
															...
															for(String phoneFeature : phoneFeatures){
																...
																setMobileToFeatures.add(mobileFeatures);
															}
														}
													}catch(Exception e){
			...
			phones.setIsActive('Y');
			phones.setIsDeleted('N');
